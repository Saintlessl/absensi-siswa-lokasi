<form action="{{ route('guru.update', ['id' => $guru->id]) }}" method="POST" id="frmEditGuru">
    @csrf
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            <label for="nip_edit" class="block text-sm font-medium text-dark-700 mb-1.5">NIP</label>
            <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <i class='bx bx-id-card text-dark-400 text-lg'></i>
                </div>
                <input type="text" name="nip" id="nip_edit" value="{{ $guru->nip }}"
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input type="text" name="nama" id="nama_edit" value="{{ $guru->nama }}"
                    class="block w-full pl-10 pr-3 py-2.5 border border-dark-200 rounded-xl bg-white focus:bg-white text-dark-800 focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500 transition-all duration-200"
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input type="text" name="mapel" id="mapel_edit" value="{{ $guru->mapel }}"
                    class="block w-full pl-10 pr-3 py-2.5 border border-dark-200 rounded-xl bg-white focus:bg-white text-dark-800 focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500 transition-all duration-200"
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input type="email" name="email" id="email_edit" value="{{ $guru->user->email ?? '' }}"
                    class="block w-full pl-10 pr-3 py-2.5 border border-dark-200 rounded-xl bg-white focus:bg-white text-dark-800 focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500 transition-all duration-200"
